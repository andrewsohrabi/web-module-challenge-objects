...
function createMenuItem(nameInput,priceInput,categoryInput){
    /*Your code here*/
    let Menu = {
      name: nameInput,
      price: priceInput,
...
console.log(createMenuItem("hot_dog",2,"fast_food"));
console.log(createMenuItem("salad",4,"appetizer"));
console.log(createMenuItem("cake",3,"dessert"));
